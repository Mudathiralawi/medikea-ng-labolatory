...
@Component({
  selector: 'app-completed-perscription-table',
  standalone: true,
  imports: [CommonModule , MatTableModule , MatPaginatorModule ],
  templateUrl: './completed-perscription-table.component.html',
  styleUrls: ['./completed-perscription-table.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class CompletedPerscriptionTableComponent {
  ...
  completedPerscription = this.patient.filter((Complete) => Complete.status === 'Dispensed') ;

  dataSource = new MatTableDataSource(this.completedPerscription);
