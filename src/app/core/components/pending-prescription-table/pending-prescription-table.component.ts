...
@Component({
  selector: 'app-pending-prescription-table',
  standalone: true,
  providers: [ MatDialog  ],
  imports: [CommonModule , MatTableModule , MatPaginatorModule , DispensingMedicineFormComponent , MatDialogModule ],
  templateUrl: './pending-prescription-table.component.html',
  styleUrls: ['./pending-prescription-table.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class PendingPrescriptionTableComponent {
  ...
  pendingPatient = this.patient.filter((Pending) => Pending.status === 'Pending');

  dataSource = new MatTableDataSource(this.pendingPatient);
