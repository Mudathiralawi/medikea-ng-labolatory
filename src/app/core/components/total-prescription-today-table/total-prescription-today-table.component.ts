...
@Component({
  selector: 'app-total-prescription-today-table',
  standalone: true,
  imports: [CommonModule , MatTableModule , MatPaginatorModule , DispensingMedicineFormComponent , MatDialogModule ],
  templateUrl: './total-prescription-today-table.component.html',
  styleUrls: ['./total-prescription-today-table.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class TotalPrescriptionTodayTableComponent implements AfterViewInit {
